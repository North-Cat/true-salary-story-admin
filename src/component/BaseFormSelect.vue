...
<template>
  <div class="w-full">
    ...
    <div ref="target" class="relative h-full">
      <div class="relative block h-full" @click.stop="dropdown = !dropdown">
        <input
          :ref="name"
          ...
          :type="type"
          readonly
          class="w-full h-full border border-black-1 rounded py-2 pl-4 pr-9"
      ...
      <ul
        v-if="dropdown"
        class="z-10 absolute mt-2 w-full rounded bg-gray shadow-input top-10 right-0 lefe-0 h-auto max-h-[336px] overflow-auto"
        s
      >
        <li
